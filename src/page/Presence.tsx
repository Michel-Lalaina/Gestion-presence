...
export default function StudentCardsPage() {
    ...
    const [students, setStudents] = useState([
        ...
        {
            id: 3,
            fullName: "Toky Nomena", matricule: "E34567890",
            mention: "Physique", parcours: "Théorique", niveau: "Post-Doctorat",
            naissance: "14/03/1879", avatarUrl: "https://i.pravatar.cc/150?img=20",
            qrColor: "bg-gray-200"
        },
        {
            id: 4, fullName: "Mario", matricule: "E56789012",
            mention: "Mathématiques", parcours: "Algorithmique", niveau: "Licence 3",
            naissance: "10/12/1815", avatarUrl: "https://i.pravatar.cc/150?img=5", qrColor: "bg-green-900"
        }
    ]);
